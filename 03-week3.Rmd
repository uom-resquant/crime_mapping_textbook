...
legend <- tm_legend(
            ...
            title.size = 0.8,
            text.size = 0.5
          ) # Legend to use in all maps

map1 <- tm_shape(manchester_crime_lsoa) +  # Specify spatial object
  tm_fill("count", fill.scale = tm_scale_intervals(style="equal"), fill.legend = legend) +  # Define fill variable and classification, set legend
  tm_title("Equal")
...
map2 <- tm_shape(manchester_crime_lsoa) +  # Specify spatial object
  tm_fill("count", fill.scale = tm_scale_intervals(style="jenks"), fill.legend = legend) +  # Define fill variable and classification, set legend
  tm_title("Jenks")
```
...
map3 <- tm_shape(manchester_crime_lsoa) +
  tm_fill("count", fill.scale = tm_scale_intervals(style="quantile"), fill.legend = legend) + 
  tm_title("Quantile")
...
map4 <- tm_shape(manchester_crime_lsoa) +
  tm_fill("count", fill.scale = tm_scale_intervals(style="sd"), fill.legend = legend) + 
...
census_lsoa_m <- read_csv("data/census_data_eon_version.csv")
```
...
res_pop_map <- tm_shape(manchester_crime_lsoa) +
  tm_fill(
    ...
    fill.legend = tm_legend(
      title = "Crimes per 100000 residents",
      position = c("right", "bottom"),
      title.size = 0.8,
      text.size = 0.5
    )
...
crime_rate_map <- tm_shape(manchester_crime_lsoa) + 
  tm_fill("crimr1", 
          ...
          fill.legend = tm_legend(
            title = "Crimes per 100000 daytime population",
            position = c("right", "bottom"),
            title.size = 0.8,
            text.size = 0.5)) + 
  tm_title("Crime rate")
