...
And there you go... Now you have a datafile with quite a few pieces of additional information about LSOAs in Manchester. You might want to save this file at this point. 

```{r, eval=FALSE}
write.csv(census_lsoa_m, file = "data/manchester_census_lsoa.csv", row.names = FALSE)
...
manchester_crime_lsoa <- manchester_crime_lsoa %>% 
  mutate(crimr1 = (count/respop)*100000, 
